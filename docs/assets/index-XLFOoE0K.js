(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))i(n);new MutationObserver(n=>{for(const a of n)if(a.type==="childList")for(const o of a.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function s(n){const a={};return n.integrity&&(a.integrity=n.integrity),n.referrerPolicy&&(a.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?a.credentials="include":n.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(n){if(n.ep)return;n.ep=!0;const a=s(n);fetch(n.href,a)}})();async function S(e,t){const i=await(await fetch("shopify:admin/api/2026-07/graphql.json",{method:"POST",body:JSON.stringify({query:e,variables:t})})).json();if(i.errors)throw new Error(i.errors.map(n=>n.message).join("; "));return i.data}async function $(e){var s;const t=await S(`#graphql
    ...
    }`,{q:e||null});return((s=t==null?void 0:t.inventoryTransfers)==null?void 0:s.nodes)||[]}async function q(e){const t=e.replace(/^#/,"").trim(),s=await $(t);if(s.length)return s;const i=await $(null),n=t.toLowerCase();return i.filter(a=>(a.name||"").toLowerCase().includes(n))}async function L(e){const t=await S(`#graphql
    ...
    }`,{id:e});return(t==null?void 0:t.inventoryShipment)||null}function k(e){const t=document.createElement("div");t.className="label";const s=document.createElement("div");s.className="style",s.textContent=e.style||"—",t.appendChild(s);const i=document.createElement("div");i.className="body";const n=document.createElement("div");n.className="info";const a=document.createElement("div");a.className="meta",a.textContent=e.meta||"",n.appendChild(a);const o=document.createElement("div");if(o.className="price",e.retail){const c=document.createElement("span");c.className="retail",c.textContent=E(e.retail),o.appendChild(c)}if(e.price!=null){const c=document.createElement("span");c.className="now",c.textContent=E(e.price),o.appendChild(c)}n.appendChild(o),i.appendChild(n);const l=document.createElement("div");l.className="barcode";const d=document.createElementNS("http://www.w3.org/2000/svg","svg");return l.appendChild(d),i.appendChild(l),t.appendChild(i),JsBarcode(d,String(e.barcode).trim(),{format:"CODE128",width:2,height:40,margin:6,displayValue:!0,fontSize:13,textMargin:2}),d.removeAttribute("width"),d.removeAttribute("height"),d.setAttribute("preserveAspectRatio","xMidYMid meet"),t}const y=document.getElementById("app"),C=document.getElementById("print-sheet"),r={transfers:null,search:"",shipment:null,rows:[],message:"",error:""};function h(e){return String(e??"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function I(e){return/\$/.test(e)||/\d\.\d{2}\b/.test(e)||/retail/i.test(e)}function A(e){return((e==null?void 0:e.selectedOptions)||[]).filter(t=>t.value&&t.value!=="Default Title"&&!/retail|price/i.test(t.name)&&!I(t.value)).map(t=>t.value).join(" · ")}function E(e){return`$${Number(e).toFixed(2)}`}function O(e){const t=parseFloat(e==null?void 0:e.price);let s=(e==null?void 0:e.compareAtPrice)!=null?parseFloat(e.compareAtPrice):NaN;if(!(s>0)){const n=((e==null?void 0:e.selectedOptions)||[]).find(a=>/retail/i.test(a.name));if(n){const a=parseFloat(String(n.value).replace(/[^0-9.]/g,""));a>0&&(s=a)}}const i=t>0&&s>t+.001;return{price:t>0?t:null,retail:i?s:null}}function N(e){return e?new Date(e).toLocaleDateString(void 0,{month:"short",day:"numeric"}):""}function b(e){return`<span class="badge ${e==="RECEIVED"?"received":/PARTIAL/i.test(e)?"partial":""}">${(e||"").replace(/_/g," ").toLowerCase()}</span>`}async function f(){r.transfers=null,r.error="",m();try{r.transfers=r.search?await q(r.search):await $(null),r.message=r.transfers.length?"":r.search?`No transfers matching “${r.search}”.`:"No transfers found."}catch(e){r.transfers=[],r.error=`Couldn't load transfers: ${e.message}`}m()}async function T(e){var t;r.message="Loading shipment…",r.error="",m();try{const s=await L(e),i=(((t=s==null?void 0:s.lineItems)==null?void 0:t.nodes)||[]).map(n=>{var l,d,c,u;const a=(l=n.inventoryItem)==null?void 0:l.variant,o=O(a);return{style:((d=a==null?void 0:a.product)==null?void 0:d.title)||((c=n.inventoryItem)==null?void 0:c.sku)||"Unknown item",meta:A(a),sku:((u=n.inventoryItem)==null?void 0:u.sku)||"",barcode:((a==null?void 0:a.barcode)||"").trim(),price:o.price,retail:o.retail,accepted:n.acceptedQuantity,qty:n.acceptedQuantity,selected:!0}});r.shipment=s,r.rows=i,r.message=""}catch(s){r.error=`Couldn't load shipment: ${s.message}`}m()}function P(){const e=r.rows.filter(t=>t.selected&&t.qty>0&&t.barcode);C.innerHTML="";for(const t of e)for(let s=0;s<t.qty;s++)C.appendChild(k(t));window.print()}function g(){return r.rows.reduce((e,t)=>e+(t.selected&&t.barcode?t.qty:0),0)}function m(){const{transfers:e,shipment:t,rows:s,message:i,error:n}=r;let a="";if(t){const o=s.length>0&&s.every(c=>c.selected),l=s.filter(c=>c.selected).length,d=s.map((c,u)=>`
